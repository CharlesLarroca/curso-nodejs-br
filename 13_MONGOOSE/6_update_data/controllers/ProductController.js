...
module.exports = class ProductController {
  ...
  static async editProductPost(req, res){
    ...
    //Não é necessário instaciar um obj, mas sim criar um obj passar os dados
    const product = {name, image, price, description}
    
    //E realizamos o updateOne diretamente no model, passando os parametros de localização no caso o _id: id e o product
