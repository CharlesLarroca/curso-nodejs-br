...
class Product {
  ...
  //Parecido com o save, a diferença é que ao chamar o metodo da classe passamos o paremetro id, que será passado como arg para o update one
  updateProduct(id){
    //Passamos o id e em set passamos os dados recebidos do args e usar o this, visto que vieram de um obj instanciado da classe
    
    conn.db().collection('product').updateOne({
      _id: new ObjectId(id)},
      {$set: this}
    )
    return
